...
namespace ChatAppApi.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<Message>> SendMessage(int chatId, [FromBody] SendMessageRequest request)
        {
            try
            {
                // Validation
        ...
        public async Task<ActionResult> UpdateMessageStatus(int chatId, int messageId, [FromBody] UpdateMessageStatusRequest request)
        {
            try
            {
